...
namespace BoardgameCollectionWebsite.Controllers
{
    public class FamiliesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "LocalFamilyID,FamilyID,FamilyName")] Family family)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "LocalFamilyID,FamilyID,FamilyName")] Family family)
        {
            if (ModelState.IsValid)
            {
